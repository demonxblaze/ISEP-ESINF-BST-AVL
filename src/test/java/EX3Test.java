...
class EX3Test {
    ...
    void getTrips() {
        ...
        AVL<Trip> result = ex3.getTrips(tripsToFind, lines);

        AVL<Trip> expected = new AVL<>();
        expected.insert(new Trip(2213, 42.28457278, -83.74321417, 42.29456361, -83.70448778));
    ...
    void getTrips2() {
        ...
        Set<Trip> tripsToFind = new HashSet<>();
        tripsToFind.add(new Trip(527, 0, 0, 0, 0));
        tripsToFind.add(new Trip(300, 0, 0, 0, 0));
        tripsToFind.add(new Trip(1000, 0, 0, 0, 0));

        AVL<Trip> result = ex3.getTrips(tripsToFind, lines);

        AVL<Trip> expected = new AVL<>();
        expected.insert(new Trip(527, 42.28457278, -83.74321417, 42.29456361, -83.70448778));
        expected.insert(new Trip(300, 42.27257083, -83.79917139, 43.27259583, -84.79918222));
        expected.insert(new Trip(1000, 42.27244472, -83.79918278, 42.27257083, -83.79917139));
    ...
    void getTrips4() {
        ...
        Set<Trip> tripsToFind = new HashSet<>();
        tripsToFind.add(new Trip(301, 0, 0, 0, 0));
    ...
    void getTrips5() {
        ...
        AVL<Trip> result = ex3.getTrips(350,400, lines);
    ...
    void getTrips7() {
        ...
        AVL<Trip> result = ex3.getTrips(2213,2213, lines);
