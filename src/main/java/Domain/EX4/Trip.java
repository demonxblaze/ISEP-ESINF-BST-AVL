...
/**
 * This class represents a trip taken by a vehicle and contains various data points related to the trip.
 */
public class Trip implements Comparable<Trip> {
    int tripID; // unique identifier for the trip
     ...
     */
    public Trip(int tripID, double dayNum, int timeStamp, int latitude, int longitude, int vehicleSpeed, int maf, int engineRPM, double absoluteLoad, int outsideTemp, int fuelRate, int airConPowerKw, int airConPowerWatt, int heaterPowerWatt, int hvBatteryCurrent, int hvBatterySoc, int hvBatteryVoltage, int shortTermFuelBank1, int shortTermFuelBank2, int longTermFuelBank1, int longTermFuelBank2) {
        setTripID(tripID);
        setDayNum(dayNum);
